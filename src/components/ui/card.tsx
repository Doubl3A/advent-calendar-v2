...
function Card({variant = "default", className, ...props}: CardComponentProps) {
    return (
        <div
            data-slot="card"
            className={cn(
                "text-card-foreground flex flex-col gap-6 rounded-xl py-6",
                variant !== "transparent" && "bg-card border shadow-sm",
                className
            )}
            {...props}
        />
...
function CardHeader({variant = "default", className, ...props}: CardHeaderProps) {
    return (
        <div
            ...
            className={cn(
                ...
                variant === "default" && "@container/card-header",
                className
            )}
            {...props}
        />
